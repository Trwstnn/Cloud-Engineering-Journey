...
Commands:
- pwd this command shows my working directory so that i wont get lost inside a file
- ls this command shows the files and folders under the current directory
- cd this allows me to change my current directory
- c ~ this makes me go to my home directory
- c .. this makes me go upper parent directory.
...
- I'd like to know how can i manage webs using this tool.
